...
public class Utils {
    ...
    public static RemoteWebDriver getRemoteWebDriver(String platformName, String platformVersion, String browserName,
        ...
        String PERFECTO_HOST = System.getProperty("np.testHost", "MYCOMPANY.perfectomobile.com");
        String PERFECTO_USER = System.getProperty("np.testUsername", "MYUSER");
        String PERFECTO_PASSWORD = System.getProperty("np.testPassword", "MYPASSWORD");
